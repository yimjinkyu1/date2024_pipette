...
PROGRAM_SERVER_MPIGRAPH="/home/sr5/jinkyu.yim/project/ai_cluster_check/3_net_mpigraph/mpiGraph"
#PROGRAM_SERVER_MPIGRAPH="${MPI_PROGRAM_PATH}/mpiGraph"
PROGRAM_SERVER_NUMARUN_MPIGRAPH="${MPI_PROGRAM_PATH}/numa_run_mpigraph.sh"
PROGRAM_MPIGRAPH_LOG_PARSER="${MPI_PROGRAM_PATH}/mpiGraph_log_parser.sh"
PROGRAM_MPIGRAPH_LOG_TO_CSV="${MPI_PROGRAM_PATH}/log_to_csv.py"
...
MPIGRAPH_LOG_FILE_TEMP="${MPIGRAPH_LOG_PATH}/mpigraph_raw_log_file_temp"
...
echo "$RUN_SCRIPT" >> $MPIGRAPH_LOG_FILE_TEMP
...
#python $PROGRAM_VIVALDI_CSV_TO_XY $MPIGRAPH_LOG_JSON_FILE > $MPIGRAPH_LOG_VIVALDI_FILE 

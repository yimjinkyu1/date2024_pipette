...
def is_last_rank():
    #[JK] 수정 필요 , last rank 인지 파악 
    #return torch.distributed.get_rank() == 31
...
def print_rank_last(message):
    ...
    #print(f"hostname : {jk_hostname}, dist_rank : {jk_dist_rank}, local_rank : {jk_local_rank}, message : {message}, print_rank_last 1, __init__.py")

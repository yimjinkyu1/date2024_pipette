...
print(f"fwd time model train time(a100) (sec) : {model_train_time_sec}")
...
# 그림 파일로 저장
filename = "mbs_fwd_time_spearman_correlation_plot_origin_a100.png"
...
torch.save(model, 'model_predict_fwd_time_a100_torch_origin_{}_{}.pkl'.format(args.origin,args.device))

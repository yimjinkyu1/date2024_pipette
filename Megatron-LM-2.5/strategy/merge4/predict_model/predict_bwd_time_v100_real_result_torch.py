...
print(f"bwd time model train time(v100) (sec) : {model_train_time_sec}")
...
# 그림 파일로 저장
filename = "mbs_bwd_time_spearman_correlation_plot_origin_v100.png"
...
torch.save(model, 'model_predict_bwd_time_v100_torch_origin_{}_{}.pkl'.format(args.origin,args.device))
